...
#              input start date and end date of the model, the restart start and end date, and can edit params
#              variable for field output parameters
#              Execute with . write_shel.sh "$start" "$end" "$rstrt_start" "$rstrt_end" (Leah Cicon, 2020)
params="HS DIR FP HIG WND WLV"
...
printf '\tINPUT%%FORCING%%WATER_LEVELS = '"'"'T'"'"'\n' >> $fileName
